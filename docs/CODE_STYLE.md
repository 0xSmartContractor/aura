You are an expert software architect tasked with creating comprehensive code style guidelines for aura. 

# Code Style Guidelines for aura

## Project Overview
AI-powered cultivation management system integrating environmental controls, analytics, and operations. Features include real-time monitoring of growing conditions, automated nutrient/climate control, yield forecasting, and pest detection. Manages inventory, employees, compliance, and financials through unified dashboard. Includes POS integration, CRM, quality assurance, and R&D tracking. Provides business intelligence through market analysis, demand forecasting, and performance metrics.   

This document defines the coding standards and style guidelines for aura, ensuring consistency and maintainability across the codebase.
